//! Fuzzing-Ziel für den PES-Parser (SM-SEC-011, SM-FMT-012).
//!
...
fuzz_target!(|daten: &[u8]| {
    let _ = kern_parsers::lies_kennwerte(kern_typen::Format::Pes, daten);
    let _ = kern_parsers::lies_stichabschnitte(kern_typen::Format::Pes, daten);
});

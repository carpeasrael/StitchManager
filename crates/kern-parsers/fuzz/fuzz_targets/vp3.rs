//! Fuzzing-Ziel für den VP3-Parser (SM-SEC-011, SM-FMT-012).
//!
...
fuzz_target!(|daten: &[u8]| {
    let _ = kern_parsers::lies_kennwerte(kern_typen::Format::Vp3, daten);
    let _ = kern_parsers::lies_stichabschnitte(kern_typen::Format::Vp3, daten);
});
